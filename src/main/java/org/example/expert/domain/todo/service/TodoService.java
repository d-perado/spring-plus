...
public class TodoService {
    ...
    public Page<TodoSearchResponse> searchTodosByTitleAndManager(int page, int size, String query, LocalDateTime start, LocalDateTime end) {
        Pageable pageable = PageRequest.of(page, size);

        return todoRepository.search(query, start, end, pageable);
    }
}
